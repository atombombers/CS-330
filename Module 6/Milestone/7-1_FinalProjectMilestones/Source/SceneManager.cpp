...
void SceneManager::LoadSceneTextures()
{
	...
	CreateGLTexture(
		"c5c14ab9-dc4f-43e2-af43-3e4fa130f60f.jpg",
		"light");
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.38f, 0.32f, 0.20f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 1.75f, 1.45f, 0.90f);
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 0.10f, 0.09f, 0.07f);
...
void SceneManager::RenderScene()
{
	...
	/*
	//SetShaderColor(0.95f, 0.95f, 0.90f, 1.0f);   // glowing white
