...
void SceneManager::RenderScene()
{
	...
	const float lampX = 5.5f; // Places the lamp near the right wall
	const float lampZ = 0.5f; // Moves the lamp slightly forward
	...
	positionXYZ = glm::vec3(lampX, baseY + 1.10f, lampZ);
	...
	positionXYZ = glm::vec3(lampX, baseY + 2.20f + 1.25f, lampZ);
	...
	positionXYZ = glm::vec3(lampX, baseY + 4.70f + 2.00f, lampZ);
