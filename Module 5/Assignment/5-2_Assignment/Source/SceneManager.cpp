...
void SceneManager::LoadSceneTextures()
{
	...
	CreateGLTexture(
		"front-materials-mushroom-punched-NEW-2.jpg",  
		"stonePlane");     

	CreateGLTexture(
		"Cream_taupe_moderately_dirty_worn_stained_grubby_concrete_seamless_tiled_square_floor_paving_texture.jpg",
		"tileCylinder");

	CreateGLTexture(
		"hintergrund-tapete-1460124357Qde.jpg",
		"woodBox");
	
	CreateGLTexture(
		"2018-06-13-10-49-06.jpg",
		"metalBox");

	CreateGLTexture(
		"water-texture-1485555036H9D.jpg",
		"waterSphere");

	CreateGLTexture(
		"steel-metallic-geometric-texture.jpg",
		"metalCone");
